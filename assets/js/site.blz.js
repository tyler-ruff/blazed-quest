...
function build_footer(config){
    ...
    const emailUpdatesForm = f('form');
    emailUpdatesForm.classList.add('form-horizontal');
    emailUpdatesForm.action = "#";
    emailUpdatesForm.method = "post";
    ...
    const enterEmail = f('input');
    enterEmail.classList.add('span2');
    enterEmail.id = "appendedPrependedInput";
    enterEmail.type = "email";
    enterEmail.required = true;
    enterEmail.placeholder = "name@example.com";
    const subscribeButton = f('button');
    ...
    emailUpdatesInner.appendChild(enterEmail);
